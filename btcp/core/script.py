# Copyright (C) 2012-2015 The python-btcplib developers
#
...
class CScript(bytes):
    ...
    def __coerce_instance(cls, other):
        ...
        if isinstance(other, CScriptOp):
            ...
            if 0 <= other <= 16:
                ...
                other = CScriptOp.encode_op_pushdata(btcp.core._bignum.bn2vch(other))
    ...
    def to_p2sh_scriptPubKey(self, checksize=True):
        ...
        return CScript([OP_HASH160, btcp.core.Hash160(self), OP_EQUAL])
...
def RawSignatureHash(script, txTo, inIdx, hashtype):
    ...
    txtmp = btcp.core.CMutableTransaction.from_tx(txTo)
    ...
    if (hashtype & 0x1f) == SIGHASH_NONE:
        ...
        for i in range(outIdx):
            txtmp.vout.append(btcp.core.CTxOut())
