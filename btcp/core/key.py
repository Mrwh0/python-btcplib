...
class CECKey:
    ...
    def sign(self, hash): # pylint: disable=redefined-builtin
        ...
        assert 1 == result
        if btcp.core.script.IsLowDERSignature(mb_sig.raw[:sig_size0.value]):
    ...
    def sign_compact(self, hash): # pylint: disable=redefined-builtin
        ...
        sig = btcp.signature.DERSignature.deserialize(sig)
