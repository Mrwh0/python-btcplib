# Copyright (C) 2012-2014 The python-btcplib developers
#
...
import btcp.core
import btcp.core._bignum
import btcp.core.key
import btcp.core.serialize
...
class EvalScriptError(btcp.core.ValidationError):
...
def _UnaryOp(opcode, stack, err_raiser):
    ...
    stack.append(btcp.core._bignum.bn2vch(bn))
    ...
    for (sop, sop_data, sop_pc) in scriptIn.raw_iter():
        ...
        if sop <= OP_PUSHDATA4:
            ...
            if sop == OP_1NEGATE or ((sop >= OP_1) and (sop <= OP_16)):
                v = sop - (OP_1 - 1)
                stack.append(btcp.core._bignum.bn2vch(v))
                ...
                check_args(1)
                stack.append(btcp.core.serialize.Hash160(stack.pop()))

            elif sop == OP_HASH256:
                check_args(1)
                stack.append(btcp.core.serialize.Hash(stack.pop()))
...
class VerifyScriptError(btcp.core.ValidationError):
    pass
...
class VerifySignatureError(btcp.core.ValidationError):
    pass
