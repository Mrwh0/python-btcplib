...
* Removed SCRIPT_VERIFY constants ``btcp.core.script``, leaving just the
  constants in ``btcp.core.scripteval``; being singletons the redundant
...
attribute of the btcp.core.key module, and the entire btcp.core.bignum
